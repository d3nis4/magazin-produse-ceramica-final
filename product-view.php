...
<link href="https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.11.3/css/lightbox.min.css" rel="stylesheet">
        ...
        <section id="prodetails" class="section-p1 product_data">
                ...
                <div class="single-pro-image">
                    <a href="uploads/<?= $product['image'];?>" data-lightbox="product-image" data-title="<?= $product['name']; ?>">
                ...
                <div class="single-pro-details">
                    ...
                    <div class="row mt-3">
                        ...
                        <p class="small text-danger">
                            <?php 
                            $cant=$product['qty'];
                            if($product['qty']<10 && $product['qty']!=1 ){echo "Au mai rămas doar $cant produse în stoc!";}
                                    else if($product['qty']==1){echo "Un singur produs disponibil!";}
                              ?>
                        </p>
                        </div>
                        <div class="col-md-6">
