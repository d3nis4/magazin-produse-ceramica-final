                    ...
                    <div id="mycart">
                        ...
                        ?>
                            ...
                            <div class="float-right">
                                <h5>Valoarea produselor din coș: <span id="totalPriceValue" class="text-end fw-bold" style="text-align: end;"><?= $totalPrice ?> lei</span></h5>
                                <a href="checkout.php" class="btn btn-primary float-right">Mergi la Checkout</a>
